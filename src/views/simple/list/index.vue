  ...
  <div>
    <TablePage :isChooseMode="props.isChooseMode">
      ...
      <template v-slot:table>
        <el-table ref="tableRef" class="table-list" v-loading="state.loading" :data="state.tableList"  table-layout="auto"
            ...
            <template #default="scope">
              <Auth :value="'btn.syslog.view'">
                ...
                <el-button size="small" type="success"
                           @click="()=>{router.push({path:'/simple/info/' + scope.row.id})}">
                  {{ $t('message.table.but_info') }}
                </el-button>
...
import {page, del, update, add, get} from "/@/api/simple";
import {getAllDataConfig, getQueryDataConfig, getModelWithout} from "/@/model/simple/dataConfig";
