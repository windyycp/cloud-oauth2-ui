			...
			<el-table :data="tableData.data" style="width: 100% ; " @selection-change="handleSelectionChange" size="default">
				...
				<el-table-column label="字典类型" align="center" >
					<template #default="scope">
						<router-link :to="'/system/dictdata/list/' + scope.row.dictType" class="link-type">
				...
				<el-table-column prop="remark" label="字典描述" align="center" ></el-table-column>
				...
				<el-table-column :label="$t('message.table.but_operation')" width="200" align="center">
					<template #default="scope">
