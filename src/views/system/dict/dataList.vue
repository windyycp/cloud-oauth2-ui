  <template>
	<div class="system-dic-container">
		<el-card shadow="never">
			<div class="system-user-search mb15">
				<el-form :model="tableData.param" ref="queryRef" :inline="true"  >
					<el-form-item label="字典类型" prop="dictType">
						<el-select v-model="tableData.param.dictType" @keyup.enter.native="dataList">
							<el-option v-for="item in typeOptions" :label="item.dictType" :value="item.dictType" />
						</el-select>
					</el-form-item>
					<!-- <el-form-item label="字典类型" prop="dictType">
            <el-input
			...
			<el-table :data="tableData.data" style="width: 100%" @selection-change="handleSelectionChange" size="default">
				<el-table-column type="selection" width="55" align="center" />
				<el-table-column label="ID" align="center" prop="id" />
				<el-table-column label="字典标签" align="center" prop="dictLabel" />
				<el-table-column label="字典标识" align="center" prop="dictCode" />
				...
				<el-table-column :label="$t('message.table.but_operation')" width="200">
					<template #default="scope">
						<el-button size="small" text type="primary" @click="onOpenEditDic(scope.row)">{{$t('message.formI18n.but_edit')}}</el-button>
						<el-button size="small" text type="primary" @click="onRowDel(scope.row)">{{$t('message.formI18n.but_delete')}}</el-button>
					</template>
				</el-table-column>
			</el-table>
...
<script lang="ts">
	...
	export default defineComponent({
		...
		setup() {
			...
			// changeType 字典类型变化后
			const changeDictType = (val : any) => {
				state.tableData.param.dictType = val;
