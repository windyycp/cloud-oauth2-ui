	...
	<div class="layout-breadcrumb-seting">
		<el-drawer title="布局配置" v-model="getThemeConfig.isDrawer" direction="rtl" destroy-on-close size="260px"
			...
			<el-scrollbar class="layout-breadcrumb-seting-bar">
				<div v-if="state.showSetting == 'true' ? true : false">
					<!-- 全局主题 -->
          ...
          <div class="layout-breadcrumb-seting-bar-flex">
            <div class="layout-breadcrumb-seting-bar-flex-label">菜单选中字体颜色</div>
            <div class="layout-breadcrumb-seting-bar-flex-value">
              <el-color-picker v-model="getThemeConfig.menuBarTitleActivityColor" size="default"
                               @change="onBgColorPickerChange('menuBarTitleActivityColor')"> </el-color-picker>
            </div>
          </div>
					<div class="layout-breadcrumb-seting-bar-flex">
					...
					<el-divider content-position="left"
						:style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">分栏设置</el-divider>
					<div class="layout-breadcrumb-seting-bar-flex"
				...
				<div class="copy-config" v-if="state.showSetting == 'true' ? true : false">
...
const state = reactive({
	isMobile: false,
	showSetting: import.meta.env.VITE_SHOW_ALL_LAYOUT_SETTING,
});
...
const initLayoutChangeFun = () => {
  ...
  onBgColorPickerChange('menuBarTitleActivityColor');
